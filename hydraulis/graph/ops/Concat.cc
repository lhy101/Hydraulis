...
void ConcatOpImpl::DoCompute(Operator& op,
  ...
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hydraulis::impl::Concat, inputs.at(0), inputs.at(1),
...
void ConcatGradientOpImpl::DoCompute(Operator& op,
  ...
  HT_DISPATCH_KERNEL_CPU_AND_CUDA(
    op->instantiation_ctx().placement.type(), type(), hydraulis::impl::ConcatGradient, 
