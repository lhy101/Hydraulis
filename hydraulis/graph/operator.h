...
#include "hydraulis/utils/context_store.h"
...
class OpDef : public shared_ptr_target {
 ...
 public:
  ...
  void Compute(const NDArrayList& inputs, NDArrayList& outputs, RuntimeContext& runtime_ctx, size_t micro_batch_id = 0) {
    ...
    HT_LOG_INFO << hydraulis::impl::comm::GetLocalDevice() << " micro batch: " << micro_batch_id << ", compute op: " << name()
    ...
    */
    ...
    HT_LOG_INFO << hydraulis::impl::comm::GetLocalDevice() << ": compute op: " << name()
