...
class TrainerCommArgs(Args):
    def __init__(self, **kwargs):
        self.input_ds_union: hydraulis.DistributedStatesUnion = kwargs["input_ds_union"]
        self.input_device_group_union: List[hydraulis.DeviceGroup] = kwargs["input_device_group_union"]
        self.label_ds_union: hydraulis.DistributedStatesUnion = kwargs["label_ds_union"]
        self.label_device_group_union: List[hydraulis.DeviceGroup] = kwargs["label_device_group_union"]
        self.local_device: hydraulis.device = kwargs["local_device"]
        self.all_devices: hydraulis.DeviceGroup = kwargs["all_devices"]
