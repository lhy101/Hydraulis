...
using namespace hydraulis::graph;
...
class ParsedPyArgs {
 public:
  ...
  //    If the context libs is empty, then `hydraulis::nullopt` will be returned.
  ...
  //    It requires the `type` is derived from `hydraulis::shared_ptr_wrapper` 
