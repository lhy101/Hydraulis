...
class ArgType:
    ...
    DATA_TYPE = 10; DATA_TYPE_STR = ("hydraulis.dtype", "dtype", "DataType")
    DEVICE = 11; DEVICE_STR = ("hydraulis.device", "device", "Device")
    DEVICE_GROUP = 12; DEVICE_GROUP_STR = ("hydraulis.DeviceGroup", "DeviceGroup")
    DG_HIERARCHY = 13; DG_HIERARCHY_STR = ("hydraulis.DeviceGroupHierarchy", "DeviceGroupHierarchy", "List[hydraulis.DeviceGroupList]", "List[DeviceGroupList]", "List[List[hydraulis.DeviceGroup]]", "List[List[DeviceGroup]]")
    STREAM = 14; STREAM_STR = ("hydraulis.stream", "stream", "Stream")
    ND_ARRAY = 15; ND_ARRAY_STR = ("hydraulis.NDArray", "NDArray", "hydraulis.ndarray", "ndarray")
    ND_ARRAY_LIST = 16; ND_ARRAY_LIST_STR = ("List[hydraulis.NDArray]", "List[NDArray]", "List[hydraulis.ndarray]", "List[ndarray]", "NDArrayList")
    TENSOR = 17; TENSOR_STR = ("hydraulis.Tensor", "Tensor", "hydraulis.tensor", "tensor")
    TENSOR_LIST = 18; TENSOR_LIST_STR = ("List[hydraulis.Tensor]", "List[Tensor]", "List[hydraulis.tensor]", "List[tensor]", "TensorList")
    OPERATOR = 19; OPERATOR_STR = ("hydraulis.Operator", "Operator", "hydraulis.operator", "operator")
    OPERATOR_LIST = 20; OPERATOR_LIST_STR = ("List[hydraulis.Operator]", "List[Operator]", "List[hydraulis.operator]", "List[operator]", "OperatorList", "OpList")
    FEED_DICT = 21; FEED_DICT_STR = ("FeedDict", "feed_dict")
    DISTRIBUTED_STATES = 22; DISTRIBUTED_STATES_STR = ("hydraulis.DistributedStates", "DistributedStates")
    DISTRIBUTED_STATES_LIST = 23; DISTRIBUTED_STATES_LIST_STR = ("List[hydraulis.DistributedStates]", "List[DistributedStates]", "DistributedStatesList") 
    DS_HIERARCHY = 24; DS_HIERARCHY_STR = ("List[hydraulis.DistributedStatesUnion]", "List[DistributedStatesUnion]", "DistributedStatesHierarchy") 
    INT_SYMBOL = 25; INT_SYMBOL_STR = ("hydraulis.IntSymbol", "IntSymbol")
    SYMBOLIC_SHAPE = 26; SYMBOLIC_SHAPE_STR = ("List[hydraulis.IntSymbol]", "List[IntSymbol]", "SyShape")
    SYMBOLIC_SHAPE_LIST = 27; SYMBOLIC_SHAPE_LIST_STR = ("List[List[[hydraulis.IntSymbol]]", "List[List[IntSymbol]]", "List[SyShape]")
    INITIALIZER = 28; INITIALIZER_STR = ("hydraulis.Initializer", "Initializer")
