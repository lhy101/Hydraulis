...
class NLLLoss(_WeightedLoss):
    ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor:
        return hydraulis.nll_loss(input, target)
...
class BCELoss(_WeightedLoss):
    ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor:
        return hydraulis.binary_cross_entropy(input, target)
...
class KLDivLoss(_WeightedLoss):
    ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor:
        return hydraulis.kl_div(input, target)
...
class MSELoss(_WeightedLoss):
    ...
    def forward(self, input: Tensor, target: Tensor) -> Tensor:
        return hydraulis.mse_loss(input, target)