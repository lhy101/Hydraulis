...
from hydraulisrpc_async_server_exp import server_launch
...
def pssh(args):
    ...
    for i, hostname in enumerate(hostnames):
        ...
        cmd_list.append(cmd + f"export HYDRAULIS_LOCAL_HOSTNAME={hostname} && " + train_command + f" 2>&1 | tee {log_path}")
    clients = []
    outputs = []
