...
python3 data/create_web_dataset.py
python3 data/gpt_seq_dataset.py # generate dataset cache, could skip here, will be generated when firstly create dataset