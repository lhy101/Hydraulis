...
if __name__ == '__main__':
    ...
    # 7b
    file_path = 'parallel_scheme_space_7b.json'
    N = 16  # 总的GPU数量
    S = 8192  # 数据集中最长的序列长度
    S_STEP = 128  # 序列长度的步长
    N_STEP = 1
    os_dp_tp_pp = (2, 4, 2)
    # 32b
    file_path = 'parallel_scheme_space_32b.json'
    N = 1024  # 总的GPU数量
    ...
    os_dp_tp_pp = (64, 16, 1)
    # 13b
    file_path = 'parallel_scheme_space_13b.json'
    N = 32  # 总的GPU数量
    ...
    os_dp_tp_pp = (8, 4, 1)
    # 7b A800
    file_path = 'parallel_scheme_space_7b.json.json'
    N = 32  # 总的GPU数量
    ...
    # dataset counter
    file_path = './web_counter.pkl'
    # file_path = './16k_code_counter.pkl'
